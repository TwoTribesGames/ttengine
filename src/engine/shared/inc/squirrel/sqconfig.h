...
#ifdef _SQ64
typedef s64     SQInteger;
typedef u64     SQUnsignedInteger;
#else 
typedef s32     SQInteger;
typedef u32     SQUnsignedInteger;
#endif

typedef uintptr SQHash; /*should be the same size of a pointer*/
typedef s32     SQInt32; 
typedef u32     SQUnsignedInteger32;
...
typedef u64 SQRawObjectVal; //must be 64bits
