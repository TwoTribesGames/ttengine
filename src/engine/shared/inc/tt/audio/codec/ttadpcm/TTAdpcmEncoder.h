#if !defined(INC_TT_AUDIO_CODEC_TTADPCM_TTADPCMENCODER_H)
#define INC_TT_AUDIO_CODEC_TTADPCM_TTADPCMENCODER_H
...
class TTAdpcmEncoder : public Encoder
{
public:
...
private:
	TTAdpcmEncoder(const TTAdpcmEncoder&);
	const TTAdpcmEncoder& operator=(const TTAdpcmEncoder&);
	...
	typedef std::vector<ADPCMState> EncodeStates;
	EncodeStates m_encodeStates;
...
#endif // !defined(INC_TT_AUDIO_CODEC_TTADPCM_TTADPCMENCODER_H)
