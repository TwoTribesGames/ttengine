		...
		namespace Property
		{
			class ColorSelector : public Property::Text
			{
					...
					void OnButtonPress( Controls::Base* /*control*/ )
					{
						...
						Gwen::Controls::RGBColorPicker* picker = new Gwen::Controls::RGBColorPicker( pMenu );
					...
					{
						Gwen::Controls::RGBColorPicker* picker = gwen_cast<Gwen::Controls::RGBColorPicker> ( control );
