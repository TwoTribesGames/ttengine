	...
	namespace Controls
	{
		...
		class GWEN_EXPORT ListBox : public ScrollControl
		{
			public:
				...
				Gwen::Event::Caller	onRowDoubleClicked;  // Two Tribes addition
				...
				void ScrollToItem(Layout::TableRow* p_item); // Two Tribes change

			protected:


				void OnRowSelected( Base* pControl );
				void OnRowDoubleClicked( Base* pControl );  // Two Tribes addition
				bool OnChar( Gwen::UnicodeChar c );
