	...
	namespace Controls
	{
		...
		class GWEN_EXPORT Base : public Event::Handler
		{
			...
			public:
				...
				virtual void RestrictToParent( bool p_restrict ) { m_bRestrictToParent = p_restrict; }
			...
			public:
				...
				virtual bool IsTabbable() { return m_Tabbable; }
				virtual void SetTabbable( bool isTabbable ) { m_Tabbable = isTabbable; }
