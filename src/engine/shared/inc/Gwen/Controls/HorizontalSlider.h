...
namespace Gwen
{
	namespace Controls
	{
		class GWEN_EXPORT HorizontalSlider : public Slider
		{
				...
				virtual void OnBoundsChanged( Gwen::Rect oldBounds );  // Two Tribes addition to fix resize handling
				virtual void OnChildBoundsChanged( Gwen::Rect oldChildBounds, Base* pChild );  // Two Tribes addition to fix resize handling
