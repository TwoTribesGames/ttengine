...
#include <spark/Extensions/Renderers/SPK_PointRendererInterface.h>
...
namespace Shared
{
	...
	class DX9PointRenderer : public TTRenderer
	{
	...
	inline void DX9PointRenderer::setTexture(const tt::engine::renderer::TexturePtr& textureIndex)
	{
	...
	inline const tt::engine::renderer::TexturePtr& DX9PointRenderer::getTexture() const
	{
		return textureIndex;
	}
