...
#include <spark/Extensions/Renderers/SPK_LineRendererInterface.h>

#define SPARK_USE_DX9LINE 0 
...
namespace Shared
{
	...
	class DX9LineRenderer : public TTRenderer, public LineRendererInterface
	{
