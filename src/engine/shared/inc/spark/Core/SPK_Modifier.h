...
namespace SPK
{
	...
	*/
	...
	protected :
		...
		void copyChildren(const Modifier& modifier,bool createBase);
	...
	inline void Modifier::setActive(bool p_active)
	{
		active = p_active;
	}

	inline void Modifier::setLocalToSystem(bool p_local)
	{
		local = p_local;
	}
