...
namespace SPK
{
	...
	*/
	...
	protected :
		...
		void copyChildren(const Emitter& emitter,bool createBase);
	...
	inline void Emitter::setActive(bool p_active)
	{
		active = p_active;
	}
	
	inline void Emitter::setTank(int p_tank)
	{
		tank = p_tank;
	}

	inline void Emitter::setFlow(float p_flow)
	{
		flow = p_flow;
	}
