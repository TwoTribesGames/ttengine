...
#include <spark/Core/SPK_BufferHandler.h>
...
namespace SPK
{
	...
	*/
	enum BlendingMode
	{
		...
		BLENDING_MULTIPLY		/**< The multiply blending is useful for Hessel ;-) */
	};
	...
	*/
	...
	inline void Renderer::setActive(bool p_active)
	{
		active = p_active;
	}
	...
	inline void Renderer::setAlphaTestThreshold(float p_alphaThreshold)
	{
		alphaThreshold = p_alphaThreshold;
	}
