...
namespace SPK
{
	...
	*/
	...
	inline LineRendererInterface::LineRendererInterface(float p_length, float p_width) :
		length(p_length),
		width(p_width)
	{}

	inline void LineRendererInterface::setLength(float p_length)
	{
		length = p_length;
	}

	inline void LineRendererInterface::setWidth(float p_width)
	{
		width = p_width;
	}
