...
namespace SPK
{
	...
	*/
	...
	protected :
		...
		void copyChildren(const NormalEmitter& emitter,bool createBase);
	...
	inline NormalEmitter* NormalEmitter::create(Zone* p_normalZone,bool p_inverted)
	{
		NormalEmitter* obj = new NormalEmitter(p_normalZone,p_inverted);
		registerObject(obj);
		return obj;
	}

	inline void NormalEmitter::setInverted(bool p_inverted)
	{
		inverted = p_inverted;
	}
