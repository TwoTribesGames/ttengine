...
namespace SPK
{
	...
	*/
	...
	inline SphericEmitter* SphericEmitter::create(const Vector3D& p_direction,float p_angleA,float p_angleB)
	{
		SphericEmitter* obj = new SphericEmitter(p_direction,p_angleA,p_angleB);
		registerObject(obj);
		return obj;
	}
