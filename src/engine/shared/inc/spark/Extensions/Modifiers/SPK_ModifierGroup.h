...
namespace SPK
{
	...
	*/
	...
	protected :
		...
		void copyChildren(const ModifierGroup& modifier,bool createBase);
	...
	inline void ModifierGroup::usePartitionGroup(bool p_handleWrongSide)
	{
		globalZone = false;
		handleWrongSide = p_handleWrongSide;
	}
