...
namespace SPK
{
	...
	*/
	...
	inline PointMass* PointMass::create(Zone* p_zone,ModifierTrigger p_trigger,float p_mass,float p_minDistance)
	{
		PointMass* obj = new PointMass(p_zone,p_trigger,p_mass,p_minDistance);
		registerObject(obj);
		return obj;
	}
	...
	inline void PointMass::setMass(float p_mass)
	{
		mass = p_mass;
	}

	inline void PointMass::setMinDistance(float p_minDistance)
	{
		minDistance = p_minDistance;
		sqrMinDistance = p_minDistance * p_minDistance;
	}
