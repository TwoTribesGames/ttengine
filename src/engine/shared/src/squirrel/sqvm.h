...
struct SQExceptionTrap{
	...
	inline SQExceptionTrap& operator=(const SQExceptionTrap& et)
	{
...
public:
    ...
    bool Get(const SQObjectPtr &self, const SQObjectPtr &key, SQObjectPtr &dest, SQUnsignedInteger getflags, SQInteger selfidx, bool getweakrefs = false);
...
#else
	static inline void Raise_Error(const SQChar *, ...) {}
	static inline void Raise_Error(const SQObjectPtr &) {}
	static inline void Raise_IdxError(const SQObjectPtr &) {}
	static inline void Raise_CompareError(const SQObject &, const SQObject &) {}
	static inline void Raise_ParamTypeError(SQInteger,SQInteger,SQInteger) {}
#endif
    ...
    bool FOREACH_OP(SQObjectPtr &o1,SQObjectPtr &o2,SQObjectPtr &o3,SQObjectPtr &o4,SQInteger arg_2,int exitpos,int &jump, bool getweakrefs);
...
////////////////////////////////////////////////////////////////////////////
	...
	inline void PushNull() { _stack[_top++].Null(); }
