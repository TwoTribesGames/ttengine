/** File generated from command line: 2_1 -style=pointer_c -spec=gl -version=2.1 -geninfo cmdline -exts ARB_framebuffer_object EXT_framebuffer_object EXT_framebuffer_blit EXT_packed_depth_stencil ARB_framebuffer_object KHR_debug**/

#include <stdlib.h>
#include <string.h>
#include <stddef.h>
#include "glloadgen/gl_2_1.h"
