...
void TreeNode::Render( Skin::Base* skin )
{
	...
	skin->DrawTreeNode( this, m_InnerPanel->Visible(), IsSelected(), m_Title->Height(), m_Title->TextRight(), m_ToggleButton->Y() + m_ToggleButton->Height() * 0.5f, iBottom, GetParent() == m_TreeControl );
}
