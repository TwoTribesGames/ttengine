...
namespace SPK
{
	Obstacle::Obstacle(Zone* p_zone,ModifierTrigger p_trigger,float p_bouncingRatio,float p_friction) :
		Modifier(INTERSECT_ZONE | ENTER_ZONE | EXIT_ZONE,INTERSECT_ZONE,true,true,p_zone),
		bouncingRatio(p_bouncingRatio),
		friction(p_friction)
	{
