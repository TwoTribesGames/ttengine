...
namespace SPK
{
	...
	void Oriented3DRendererInterface::setOrientation(LookOrientation p_lookOrientation,UpOrientation p_upOrientation,LockedAxis p_lockedAxis)
	{
		lookOrientation = p_lookOrientation;
		upOrientation   = p_upOrientation;
		lockedAxis      = p_lockedAxis;
	}
