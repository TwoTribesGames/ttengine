...
#include <tt/engine/renderer/DXUT/DXUTgui.h>
#include <tt/engine/renderer/DXUT/DXUTsettingsDlg.h>
#include <tt/engine/renderer/DXUT/DXUTres.h>
...
//--------------------------------------------------------------------------------------
void CDXUTElement::SetTexture( UINT p_iTexture, RECT* prcTexture, D3DCOLOR defaultTextureColor )
{
    this->iTexture = p_iTexture;
...
//--------------------------------------------------------------------------------------
void CDXUTElement::SetFont( UINT p_iFont, D3DCOLOR defaultFontColor, DWORD p_dwTextFormat )
{
    this->iFont = p_iFont;
    this->dwTextFormat = p_dwTextFormat;
